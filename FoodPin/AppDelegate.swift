...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // Bar Button Item颜色
        UIBarButtonItem.appearance().tintColor = UIColor(red: 235/255, green: 73/255, blue: 27/255, alpha: 1)
        // Toolbar颜色
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.duelsol.FoodPin" in the application's documents Application Support directory.
